...
var swiper = new Swiper(".hero__slider--activation", {
  ...
  swiper4 = new Swiper(".testimonial__swiper--column4", {
    slidesPerView: 4,
    loop: !0,
    clickable: !0,
    spaceBetween: 30,
  ...
  document.querySelectorAll("[data-countdown]").forEach(function (elem) {
    const countDownItem = function (value, label) {
      ...
      countDownInterval = setInterval(function () {
        ...
        (elem.innerHTML =
          countDownItem(daysValue, "Gün") +
          countDownItem(hoursValue, "Saat") +
          countDownItem(minutesValue, "Dakika") +
          countDownItem(secondsValue, "Saniye")),
