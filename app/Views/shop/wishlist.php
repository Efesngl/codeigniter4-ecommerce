                ...
                <div class="row row-cols-1">
                    <div class="col">
                        <div class="breadcrumb__content">
                            <h1 class="breadcrumb__content--title text-white mb-10">İStek Listesi</h1>
                            <ul class="breadcrumb__content--menu d-flex">
                                <li class="breadcrumb__content--menu__items"><a class="text-white" href="index.html">Ana Sayfa</a></li>
                                <li class="breadcrumb__content--menu__items"><span class="text-white">İStek Listesi</span></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <section class="cart__section section--padding">
            <div class="container">
                <div class="cart__section--inner">
                    <form action="#"> 
                        <h2 class="cart__title mb-40">İstek Listesi</h2>
                        <div class="cart__table">
                            <table class="cart__table--inner">
                                <thead class="cart__table--header">
                                    <tr class="cart__table--header__items">
                                        ...
                                        <th class="cart__table--header__list">Ürün Durumu</th>
                                    ...
                                    <tr class="cart__table--body__items">
                                        <td class="cart__table--body__list">
                                            <div class="cart__product d-flex align-items-center">
                                                <button data-product_id="<?php echo $product_id[$i];?>" class="cart__remove--btn" id="wishlist-remove" aria-label="search button" type="button"><svg fill="currentColor" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" width="16px" height="16px"><path d="M 4.7070312 3.2929688 L 3.2929688 4.7070312 L 10.585938 12 L 3.2929688 19.292969 L 4.7070312 20.707031 L 12 13.414062 L 19.292969 20.707031 L 20.707031 19.292969 L 13.414062 12 L 20.707031 4.7070312 L 19.292969 3.2929688 L 12 10.585938 L 4.7070312 3.2929688 z"/></svg></button>
                                                <div class="cart__thumbnail">
                                                    <a href="product-details.html"><img class="border-radius-5" src="<?php echo base_url($product_images[$i]);?>" alt="cart-product"></a>
                                                </div>
                                                <div class="cart__content">
                                                    <h4 class="cart__content--title"><a href="product-details.html"><?php echo $product_name[$i];?></a></h4>
                                                    <span class="cart__content--variant">Renk: <?php echo $product_color[$i];?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="cart__table--body__list">
                                            <span class="cart__price"><?php echo $product_price[$i];?> TL</span>
                                        </td>
                                        <td class="cart__table--body__list text-center">
                                            <span class="in__stock text__secondary"><?php echo $product_status[$i];?></span>
                                        </td>
                                        <td class="cart__table--body__list text-right">
                                            <?php if($product_status_number[$i]!="2"){ ?>
                                                 <button class='wishlist__cart--btn primary__btn' id="wishlist-add-to-chart" data-product_id="<?php echo $product_id[$i];?>">Sepete Ekle</button>
                                           <?php }?>
                                        </td>
                                    </tr>
                                    <?php endfor; ?>
                            ...
                            <div class="continue__shopping d-flex justify-content-end">
                                <a class="continue__shopping--link" href="<?php echo base_url("market");?>">Alışverişe Devam Et</a>
                            </div>
                        </div> 
                    </form> 
                </div>
