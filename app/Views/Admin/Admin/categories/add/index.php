...
<html lang="tr">
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                    ...
                                    <input type="text" name="category_name" id="cat-name" class="form-control mb-3" placeholder="Kategori İsmi">
                                    ...
                                    <div class="row pt-2">
                                        <div class="col text-center">
                                            <button type="submit" id="add-cat" class="btn btn-primary">Kaydet</button>
                                        </div>
                                    </div>
                            </div>
                        </div>
        ...
        <script src="/admin_assets/js/categories/category_add.js"></script>
    </body>
